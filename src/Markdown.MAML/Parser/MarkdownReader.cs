...
{
    internal enum MarkdownReaderContext
    {
        None,
    ...
    internal sealed class MarkdownReader
    {
        ...
        /// </summary>
        private static char[] LineEndingCharacters = new char[] { '\r', '\n' };
        ...
        private static char[] TextStopCharacters = new char[] { '\r', '\n', '[', '*', '`', '_' };
        private static char[] LinkNameStopCharacters = new char[] { '\r', '\n', ']' };
        private static char[] LinkUrlStopCharacters = new char[] { '\r', '\n', ')' };
        private static char[] YamlHeaderStopCharacters = new char[] { '\r', '\n', ':' };

        private static string TripleDash = "---";

        internal MarkdownReader(bool preserveFormatting, bool yamlHeaderOnly)
        {
